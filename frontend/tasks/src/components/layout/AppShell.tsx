...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/tasks', label: 'Task', icon: <path d="M7 3h10v3H7zm0 6h10m-10 4h10m-10 4h6M5 5h0m0 6h0m0 4h0m0 4h0" /> },
  ...
  { href: '/users', label: 'Users', adminOnly: true, icon: <path d="M16 11a4 4 0 1 0-8 0m12 7a7 7 0 0 0-16 0m6-7h4" /> },
  { href: '/reports', label: 'Reports', icon: <path d="M5 20V10m7 10V4m7 16v-8" /> },
  { href: '/settings', label: 'Setting', icon: <path d="M10.6 3.5h2.8l.5 2a7.3 7.3 0 0 1 1.4.8l2-.6 1.4 2.4-1.5 1.4a7.6 7.6 0 0 1 0 1.6l1.5 1.4-1.4 2.4-2-.6a7.3 7.3 0 0 1-1.4.8l-.5 2h-2.8l-.5-2a7.3 7.3 0 0 1-1.4-.8l-2 .6-1.4-2.4 1.5-1.4a7.6 7.6 0 0 1 0-1.6L5.3 8.1l1.4-2.4 2 .6a7.3 7.3 0 0 1 1.4-.8zM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" /> },
];
...
export function AppShell({ children }: AppShellProps) {
  ...
  const visibleNavItems = NAV_ITEMS.filter((item) => !item.adminOnly || currentUser?.systemRole === 'admin');
